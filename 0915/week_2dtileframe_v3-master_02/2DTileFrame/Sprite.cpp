	...
	ID3DXSprite * spriteDX)
{
	...
	HRESULT hr;
	{
...

		{
			...
			frame->Init(_spriteDX, _textureDX, 0, 0, 32, 32, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255),1.0f);
			_frameList.push_back(frame);
		}
		{
			Frame* frame = new Frame();
			frame->Init(_spriteDX, _textureDX, 64, 0, 32, 32, 0.9f,D3DCOLOR_ARGB(255, 0, 255, 255),5.0f);
			_frameList.push_back(frame);
		}
		/*{
			Frame* frame = new Frame();
			frame->Init(_spriteDX, _textureDX, 0, 0, 32, 32, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
			_frameList.push_back(frame);
		}
		{
			Frame* frame = new Frame();
			frame->Init(_spriteDX, _textureDX, 64, 0, 32, 32, 0.1f, D3DCOLOR_ARGB(255, 255, 255, 255));
			_frameList.push_back(frame);
		}
		{
			Frame* frame = new Frame();
